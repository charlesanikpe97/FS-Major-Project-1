...
This is a responsive website with animations and contact info, designed to display your professional projects in an engaging way.
...
- [-] Framework grid system implementation(containers, rows, columns) OR Flexbox implementation
- [x] Framework component usage or build your own (buttons, cards, navigation, forms)
...
- [x] CSS-only interactive components (dropdowns, modals, accordions)
